function CopyToClipboard(e, t, o) {
	...
	t &&
		0 == a.length &&
		((a = $("<div/>", { class: "copy-notification", text: o })),
		$("body").append(a),
...
jQuery(window).on("load", function () {
	...
	jQuery(document).ready(function () {
		...
		$(document).on("touchstart click", function (e) {
			0 != $(e.target).parents(".left-side-bar").length ||
			...
			$(".fa-hover").click(function (e) {
				e.preventDefault(),
					CopyToClipboard(
						$(this).find(".icon-copy").first().prop("outerHTML"),
						!0,
						"Copied"
					);
			}),
	...
	(function (a) {
		a.fn.vmenuModule = function (e) {
			var t,
				o,
				n = a.extend({ Speed: 220, autostart: !0, autohide: 1 }, e);
			(o = (t = a(this)).find("ul").parent("li").children("a")).attr(
				"data-option",
				"off"
			),
				o.unbind("click").on("click", function () {
					var e = a(this);
					n.autohide &&
						e
							.parent()
							...
							.parent("li")
							.children("ul")
							.slideUp(n.Speed / 1.2, function () {
								a(this).parent("li").children("a").attr("data-option", "off"),
									a(this).parent("li").removeClass("show");
							}),
						...
						"on" == e.attr("data-option") &&
							(e.attr("data-option", "off"),
							e.parent("li").children("ul").slideUp(n.Speed),
							e.parent("li").removeClass("show"));
				}),
				n.autostart
					...
					: t.find("a.active").each(function () {
							a(this)
								...
								.slideDown(n.Speed, function () {
									a(this).parent("li").children("a").attr("data-option", "on"),
										a(this).parent("li").addClass("show");
								});
					  });
		};
